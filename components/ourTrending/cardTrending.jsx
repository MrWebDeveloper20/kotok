...
const CardTrending = (props) => {
  return (
    <div className="Group126 w-1/3 h-96 relative">
      <div className="Frame43 flex flex-row justify-center h-96 ">
        <div className="Frame90 w-80 h-96 left-7 top-0 absolute   gap-2.5 inline-flex">
          <div className="Frame88 w-80 h-96 relative bg-white">
            <Image
              alt=""
              width={500}
              height={100}
            ...
            />
            <div className="Rectangle770 w-80 h-72 left-0 top-[264.50px] absolute bg-white" />
            <div className="DateTimeClockFive w-6 h-6 left-[18px] top-[473.15px] absolute" />
            <div className="VisitingIstanbulAndCharmingMediterraneanCities w-80 h-20 left-[17px] top-[327px] absolute text-neutral-700 text-xl font-semibold font-['Montserrat'] capitalize leading-normal">
              {props.cardDesc}
            ...
            <div className="Group34 w-38 h-6 left-[17px] top-[274px] absolute">
              ...
              <div className="Turkey ml-3 w-24 h-2.5 left-[16.06px] top-[5px] absolute text-black text-opacity-75 text-xs font-normal font-['Montserrat'] capitalize">
                {props.cardCountry}
              </div>
            ...
            <div className="Group42  origin-top-left rotate-[-15deg] w-72 h-14 left-[-23px] top-[138px] absolute">
              <div className="Rectangle783 rounded-tl-full rounded-tr-full w-52 h-14 left-0 top-0 absolute origin-top-left rotate-[-35deg] bg-red-500" />
              <div className="Featured w-44 h-11 left-[10px] top-[-4px] absolute origin-top-left rotate-[-35deg] text-center text-white text-2xl font-semibold font-['Inter'] leading-loose">
                FEATURED
              </div>
            </div>
          </div>
        </div>
        <div className="Frame100 p-2.5 left-[198px] top-[474px] absolute flex-col justify-start items-start gap-2.5 inline-flex">
          <div className="Button px-6 w-32 py-4 bg-red-500 rounded-md justify-start items-start gap-2 inline-flex">
